...
var CanvasVideoPlayer = function(options) {
	...
	if ( typeof window.jQuery != 'undefined' ) {
		this.video = window.jQuery(this.options.videoSelector)[0];
	} else {
...
CanvasVideoPlayer.prototype.load = function() {
	this.video.load();
};
...
CanvasVideoPlayer.prototype.loop = function() {
	...
	if ($(this.canvas).parent().attr('data-cover') !== undefined && this.video.currentTime > 0.5) {
		$(this.canvas).parent().find('.hide-bg').css({'opacity':'0'});
	}
